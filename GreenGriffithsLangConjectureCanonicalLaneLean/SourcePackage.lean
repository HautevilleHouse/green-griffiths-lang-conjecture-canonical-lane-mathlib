/-!
# Source package model for `green-griffiths-lang-conjecture-canonical-lane`
...
def sourceCheckoutHead : String := "dbd6a2bbec244d3cc2e57b996461ddcf7e7b1ce0"
...
def sourceFiles : List SourceFile := [
  ...
  { path := "scripts/ggl_closure_guard.py", sha256 := "d2297df6b0bbe6315664934d2863cc9286f13c53da9f441d002203284a6d1140", functionCount := 9, classCount := 0, assignmentCount := 8, parseOk := true },
...
def sourceFunctions : List SourceFunctionDecl := [
  ...
  { file := "scripts/ggl_closure_guard.py", name := "_finite", args := ["v"], returns := "bool", doc := "", line := 31, isAsync := false },
  { file := "scripts/ggl_closure_guard.py", name := "_resolve", args := ["path_str"], returns := "Path", doc := "", line := 35, isAsync := false },
  { file := "scripts/ggl_closure_guard.py", name := "_bootstrap_registry", args := ["path"], returns := "None", doc := "", line := 40, isAsync := false },
  { file := "scripts/ggl_closure_guard.py", name := "_load_registry", args := ["path"], returns := "dict[str, Any]", doc := "", line := 46, isAsync := false },
  { file := "scripts/ggl_closure_guard.py", name := "_load_sigma_from_stitch", args := ["path"], returns := "float | None", doc := "", line := 58, isAsync := false },
  { file := "scripts/ggl_closure_guard.py", name := "_entry", args := ["constants", "key"], returns := "tuple[float | None, bool]", doc := "", line := 75, isAsync := false },
  { file := "scripts/ggl_closure_guard.py", name := "compute_report", args := ["data", "sigma_star", "strict_coh_zero"], returns := "dict[str, Any]", doc := "", line := 86, isAsync := false },
  { file := "scripts/ggl_closure_guard.py", name := "append_history", args := ["path", "report"], returns := "None", doc := "", line := 119, isAsync := false },
  { file := "scripts/ggl_closure_guard.py", name := "main", args := [], returns := "None", doc := "", line := 126, isAsync := false },
...
def sourceAssignments : List SourceAssignmentDecl := [
  ...
  { file := "scripts/ggl_closure_guard.py", name := "SCRIPT_DIR", value := "Path(__file__).resolve().parent", line := 13 },
  { file := "scripts/ggl_closure_guard.py", name := "PROJECT_ROOT", value := "SCRIPT_DIR.parent", line := 14 },
  { file := "scripts/ggl_closure_guard.py", name := "DEFAULT_REGISTRY", value := "\"artifacts/constants_registry.json\"", line := 16 },
  { file := "scripts/ggl_closure_guard.py", name := "DEFAULT_STITCH", value := "\"artifacts/stitch_constants.json\"", line := 17 },
  { file := "scripts/ggl_closure_guard.py", name := "DEFAULT_OUT", value := "\"repro/certificate_runtime.json\"", line := 18 },
  { file := "scripts/ggl_closure_guard.py", name := "DEFAULT_HISTORY", value := "\"repro/drift_guard_runs.jsonl\"", line := 19 },
  { file := "scripts/ggl_closure_guard.py", name := "PRIMARY_KEYS", value := "[\"kappa_entire\", \"sigma_hyperbolic\", \"kappa_compact\", \"rho_rigidity\", \"jet_transfer\"]", line := 21 },
  { file := "scripts/ggl_closure_guard.py", name := "COHERENCE_KEY", value := "\"eps_coh\"", line := 28 },
...
def constantSpecs : List ConstantSpec := [
  { group := "constants", key := "kappa_entire", status := "derived_numeric", formula := "c_entire_raw * jet_density_raw - e_entire_raw", sourceSection := "paper/GREEN_GRIFFITHS_LANG_CONJECTURE_PREPRINT.md Section 4.5 / Appendix A", validation := "required_positive", componentKeys := ["c_entire_raw", "e_entire_raw", "jet_density_raw"] },
  { group := "constants", key := "sigma_hyperbolic", status := "derived_numeric", formula := "hyperbolic_floor_raw - jet_loss_raw - restart_loss_raw", sourceSection := "paper/GREEN_GRIFFITHS_LANG_CONJECTURE_PREPRINT.md Section 5.2 / Appendix B", validation := "required_positive", componentKeys := ["hyperbolic_floor_raw", "jet_loss_raw", "restart_loss_raw"] },
  { group := "constants", key := "kappa_compact", status := "derived_numeric", formula := "1.0 / (1.0 + delta_comp_sup_raw)", sourceSection := "paper/GREEN_GRIFFITHS_LANG_CONJECTURE_PREPRINT.md Section 5.3 / Appendix C", validation := "required_positive", componentKeys := ["delta_comp_sup_raw"] },
  { group := "constants", key := "rho_rigidity", status := "derived_numeric", formula := "rho_rigidity_raw", sourceSection := "paper/GREEN_GRIFFITHS_LANG_CONJECTURE_PREPRINT.md Section 6.1 / Appendix D", validation := "required_positive", componentKeys := ["rho_rigidity_raw"] },
  { group := "constants", key := "jet_transfer", status := "derived_numeric", formula := "c_transfer_raw * transfer_gain_raw - e_transfer_raw", sourceSection := "paper/GREEN_GRIFFITHS_LANG_CONJECTURE_PREPRINT.md Section 6.2 / Appendix E.4", validation := "required_positive", componentKeys := ["c_transfer_raw", "e_transfer_raw", "transfer_gain_raw"] },
  { group := "constants", key := "eps_coh", status := "derived_numeric", formula := "eps_coh_raw", sourceSection := "paper/GREEN_GRIFFITHS_LANG_CONJECTURE_PREPRINT.md Appendix E.6", validation := "required_nonnegative", componentKeys := ["eps_coh_raw"] },
  { group := "stitch", key := "sigma_star_can", status := "derived_numeric", formula := "sigma_star_can_raw", sourceSection := "paper/GREEN_GRIFFITHS_LANG_CONJECTURE_PREPRINT.md Section 5 / stitch constants", validation := "required_positive", componentKeys := ["sigma_star_can_raw"] }
]

def registryConstants : List RegistryConstant := [
  { key := "eps_coh", value := "0.0", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#eps_coh", sourceSection := "paper/GREEN_GRIFFITHS_LANG_CONJECTURE_PREPRINT.md Appendix E.6" },
  { key := "jet_transfer", value := "1.030627", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#jet_transfer", sourceSection := "paper/GREEN_GRIFFITHS_LANG_CONJECTURE_PREPRINT.md Section 6.2 / Appendix E.4" },
  { key := "kappa_compact", value := "0.801924619085806", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#kappa_compact", sourceSection := "paper/GREEN_GRIFFITHS_LANG_CONJECTURE_PREPRINT.md Section 5.3 / Appendix C" },
  { key := "kappa_entire", value := "1.0918990000000002", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#kappa_entire", sourceSection := "paper/GREEN_GRIFFITHS_LANG_CONJECTURE_PREPRINT.md Section 4.5 / Appendix A" },
  { key := "rho_rigidity", value := "1.078", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#rho_rigidity", sourceSection := "paper/GREEN_GRIFFITHS_LANG_CONJECTURE_PREPRINT.md Section 6.1 / Appendix D" },
  { key := "sigma_hyperbolic", value := "1.0739999999999998", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#sigma_hyperbolic", sourceSection := "paper/GREEN_GRIFFITHS_LANG_CONJECTURE_PREPRINT.md Section 5.2 / Appendix B" }
]
