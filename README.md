# Green Griffiths Lang Conjecture — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/green-griffiths-lang-conjecture-canonical-lane-mathlib.git
cd green-griffiths-lang-conjecture-canonical-lane-mathlib
lake exe
lake build
```
